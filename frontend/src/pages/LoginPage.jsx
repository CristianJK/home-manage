    ...
    <main className="flex min-h-screen w-full">
      ...
      <section className="flex flex-col items-center justify-center w-full lg:w-1/2 bg-tertiary p-6">
        <div className="w-full max-w-md space-y-6">
          ...
          {serverError && (
            <div className="bg-error-bg border border-error-border text-error-text text-sm rounded-lg p-3">
              {serverError}
            </div>
          )}
          ...
          <form className="space-y-4" id="loginForm" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input
                  {...register('email')}
                  className="w-full pl-10 pr-4 py-3 bg-surface border border-outline rounded-lg text-text-primary focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
                  id="email"
            ...
            <button
              className="w-full py-4 bg-primary text-on-primary rounded-lg text-lg font-bold hover:shadow-lg active:scale-[0.98] transition-all duration-200"
              type="submit"
