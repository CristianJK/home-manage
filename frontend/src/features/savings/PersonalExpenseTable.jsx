const categoryConfig = {
  food: { icon: 'restaurant_menu', label: 'Comida' },
  transportation: { icon: 'directions_car', label: 'Transporte' },
  housing: { icon: 'home', label: 'Vivienda' },
  entertainment: { icon: 'movie', label: 'Entretenimiento' },
  other: { icon: 'more_horiz', label: 'Otro' },
}

export function PersonalExpenseTable({ expenses, onEdit, onDelete, maxRows }) {
